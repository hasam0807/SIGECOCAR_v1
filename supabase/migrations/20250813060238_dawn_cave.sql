...
CREATE POLICY "Usuarios autenticados pueden ver convenios"
  ON convenios FOR SELECT
  TO authenticated
  USING (true);

CREATE POLICY "Usuarios autenticados pueden crear convenios"
  ON convenios FOR INSERT
  TO authenticated
  WITH CHECK (true);

CREATE POLICY "Usuarios autenticados pueden actualizar convenios"
  ON convenios FOR UPDATE
  TO authenticated
  USING (true);

CREATE POLICY "Usuarios autenticados pueden eliminar convenios"
  ON convenios FOR DELETE
  TO authenticated
  USING (true);

-- Políticas similares para las demás tablas
CREATE POLICY "Acceso completo a presupuesto_items" ON presupuesto_items FOR ALL TO authenticated USING (true);
CREATE POLICY "Acceso completo a giros" ON giros FOR ALL TO authenticated USING (true);
CREATE POLICY "Acceso completo a rendimientos" ON rendimientos FOR ALL TO authenticated USING (true);
CREATE POLICY "Acceso completo a documentos" ON documentos FOR ALL TO authenticated USING (true);
CREATE POLICY "Acceso completo a alertas" ON alertas FOR ALL TO authenticated USING (true);
CREATE POLICY "Acceso completo a auditoria" ON auditoria FOR ALL TO authenticated USING (true);
CREATE POLICY "Acceso completo a configuracion" ON configuracion FOR ALL TO authenticated USING (true);
...
BEGIN
  ...
  ON CONFLICT (convenio_id, periodo) DO UPDATE SET
